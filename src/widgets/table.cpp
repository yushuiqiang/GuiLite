...
void c_table::set_row_num(unsigned int row_num)
{
    m_row_num = row_num;
}
void c_table::set_col_num(unsigned int col_num)
{
    m_col_num = col_num;
}
...
unsigned int c_table::get_row_num()
{
    return m_row_num;
}
unsigned int c_table::get_col_num()
{
    return m_col_num;
}
