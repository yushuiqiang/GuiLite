...
c_wnd* c_slide_group::get_slide(int index)
{
    return m_slides[index];
}
c_wnd* c_slide_group::get_active_slide()
{
    return m_slides[m_active_slide_index];
}
int c_slide_group::get_active_slide_index()
{
    return m_active_slide_index;
}
int c_slide_group::add_slide(c_wnd* slide,
...
void c_slide_group::on_navigate(NAVIGATION_KEY key)
{
